    ...
    return (
        <div className={styles.block} id="checkoutEmailSetup">
            ...
            {!isExternalLoginLink
                ? (
                    <>
                    <Button align="left" variant="text" href={generateLoginRedirect()} className={classNames(styles.btnLink, "clear-margin-padding")}>
                        <Typography variant="span" type="regular" size="12">
                            {t('checkout:haveAccount:desc')}
                        </Typography>
                        <Typography variant="span" type="regular" decoration="underline" size="12">
                            {t('checkout:haveAccount:button')}
                        </Typography>
                    </Button>
                    </>
                )
